...
// @ts-nocheck 
/*
 * This file exports the `IngestionLog` model and its related types.
 *
...
export type GetIngestionLogAggregateType<T extends IngestionLogAggregateArgs> = {
      [P in keyof T & keyof AggregateIngestionLog]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateIngestionLog[P]>
    : Prisma.GetScalarType<T[P], AggregateIngestionLog[P]>
}
...
type GetIngestionLogGroupByPayload<T extends IngestionLogGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<IngestionLogGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof IngestionLogGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], IngestionLogGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], IngestionLogGroupByOutputType[P]>
      }
    >
  >
...
export type IngestionLogCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<IngestionLogFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface IngestionLogDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['IngestionLog'], meta: { name: 'IngestionLog' } }
  /**
   ...
   * })
  **/
  count<T extends IngestionLogCountArgs>(
    args?: Prisma.Subset<T, IngestionLogCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], IngestionLogCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends IngestionLogGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, IngestionLogGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetIngestionLogGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
